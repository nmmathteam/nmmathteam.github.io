...
<ul>
    ...
    <li><a href="/?e=sponsors">Sponsors</a></li>
...
`;window.onscroll=()=>{if(window.scrollY>=10)$('nav').classList.add('collapsed-nav');else window.scrollY<=0&&$('nav').classList.remove('collapsed-nav')};
